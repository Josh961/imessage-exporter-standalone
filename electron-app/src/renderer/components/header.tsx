  ...
  return (
    <header className="relative flex flex-col items-center px-4 pb-4 pt-6">
      <div className="flex items-center justify-center">
        ...
        <button
          onClick={onInfoClick}
          className="ml-2 text-slate-700 hover:text-slate-800 focus:outline-none"
          aria-label="About"
        >
          <svg
      ...
      <button
        ...
        className="absolute right-4 top-4 text-slate-700 hover:text-slate-800 focus:outline-none"
        aria-label="Settings"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
