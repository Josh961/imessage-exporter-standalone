      ...
      >
        ...
        <div className="space-y-4 text-sm text-slate-600">
          <p>
            ...
            <button
              onClick={() =>
                handleLinkClick("https://github.com/ReagentX/imessage-exporter/tree/develop")
              }
          ...
          <p>
            This version is packaged as a standalone alternative, also open source, and can be found
            at{" "}
            <button
              onClick={() =>
                handleLinkClick("https://github.com/Josh961/imessage-exporter-standalone")
              }
              className="text-sky-500 hover:text-sky-600 hover:underline"
            >
          ...
          <p>
            The installed executable is bundled with ImageMagick. ImageMagick is licensed under the
            ImageMagick License, which can be found at{" "}
            <button
              onClick={() => handleLinkClick("https://imagemagick.org/script/license.php")}
              className="text-sky-500 hover:text-sky-600 hover:underline"
            >
